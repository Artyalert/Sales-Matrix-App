...
class _InvoiceCompareScreenState extends State<InvoiceCompareScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: customAppBar(title: "Invoice Comparison"),
  ...
  Widget _fileSelectorCard({
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            const Icon(Icons.picture_as_pdf, color: AppColors.redColor),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(
                      fontSize: 13,
                      color: fileName == null ? AppColors.greyColor : Colors.green[700],
                    ),
                ...
                return Card(
                  ...
                  child: ListTile(
                    leading: CircleAvatar(
                      backgroundColor: isMismatch ? AppColors.redColor :AppColors.green,
                      child: Icon(
